...
\begin{itemize}
    ...
    \item Volumni (angl. volumes) - shramba podatkov, ki je neodvisna od življenskega cikla vsebnika in na ta način omogoča dolgotrajno shrambo podatkov, tudi ob zaustavitvi ali ponovnem zagonu vsebnika.
...
\section{Konfiguracijski strežnik Consul}
\label{subsec:konfiguracijski-strežnik-consul}

Consul je porazdeljena omrežna platforma za upravljanje s storitvami, ki omogoča odkrivanje storitev, upravljanje konfiguracije in preverjanje zdravja storitev. Ena izmed glavnih komponent platforme Consul je konfiguracijski strežnik Consul, ki omogoča hranjenje in upravljanje aplikacijske konfiguracije na centralen način, ki je lahko dostopen.
...
\label{subsec:vtičnik-gitlab-template-lint}
