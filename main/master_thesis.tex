...
Maven\footnote{\url{https://maven.apache.org/}} je orodje za avtomatizacijo gradnje projektov spisanih v jeziku Java, ki razvijalcem pomaga avtomatizirati proces gradnje, testiranja in namestitve aplikacije. Uporablja deklarativen pristop s katerim razvijalci naštejejo vse odvisnosti, vtičnike in ostale informacije potrebne za gradnjo projekta v datoteko \texttt{pom.xml} \cite{Varanasi2019}.
