...
Naslednji dve nalogi sta gradnja projekta in zagon testov enot. Obe nalogi sta odvisni od programskega jezika in orodji, ki jih projekt uporablja. V projektu medius-cd imamo pripravljene naloge za gradnjo in zagon testov enot projektov, ki uporabljajo programski jezik Javo in orodje Maven, Python, setuptools in tox ter Javascript in npm ali pnpm.

\subsection{Gradnja slik Docker}

Po uspešni gradnji projekta in testih enot se zažene naloga, ki zgradi aplikacijsko sliko Docker. Naloga je odvisna od gradnje projekta, saj velikokrat potrebujemo rezultat gradnje projekta za gradnjo slike Docker.
...
\subsection{Izdaja slike Docker}

\subsection{Namestitev aplikacije}

\subsection{Izdaja nove verzije}
